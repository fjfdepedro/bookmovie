class LibrosController < ApplicationController
  ...
  def index
    # @libros = Libro.all
    @libros = Libro.all.order_by({title:0}).limit(100)
  end
  ...
  private
    ...
    def libro_params
      params.require(:libro).permit(:title, :created, :last_modified, :last_modified, :latest_revision, :key, :authors, :type, :subjects, :revision)
    end
end
